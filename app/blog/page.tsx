...
import { BloggerIcon, Calendar02Icon } from "@hugeicons/core-free-icons";
        ...
        <div className="w-full max-w-3xl">
          <Card className="pointer-events-auto relative z-10 backdrop-blur-sm shadow-2xl bg-[rgba(0,0,0,0.1)] dark:bg-[rgba(255,255,255,0.1)] rounded-md">
            <CardHeader className="border-b border-border">
              ...
              <CardDescription>Thoughts, tutorials, and updates</CardDescription>
            </CardHeader>
              ...
              {publishedPosts.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <p className="text-sm text-muted-foreground max-w-sm">
                    Blog posts will appear here once they are published. Check
